...
export const ModalIdentidadGit: React.FC<ModalIdentidadGitProps> = ({
  ...
  return (
    <Dialogo
      ...
      className="w-[480px] max-w-[95vw] rounded-xl border border-[#23283b] bg-[#181c2d] p-0 shadow-2xl backdrop:bg-black/60"
    >
      <div className="flex items-center justify-between px-5 py-4 border-b border-[#23283b]">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 id="titulo-identidad-git" className="text-sm font-semibold text-slate-100">
              Identidad Git
            </h2>
      ...
      >
        ...
        {!cargando && (
          <div className="flex items-center justify-end gap-2 -mx-5 -mb-4 px-5 py-3 border-t border-[#23283b]">
            <button
              type="button"
              onClick={onClose}
