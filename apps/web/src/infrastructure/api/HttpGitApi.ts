// Austria: Adaptador de infraestructura HTTP para comunicacion con la API REST DDD
import {
  CommitModel,
  BranchModel,
...
export class HttpGitApi {
  ...
  async compareBranches(repoPath: string, baseBranch: string, targetBranch: string): Promise<BranchComparisonModel> {
